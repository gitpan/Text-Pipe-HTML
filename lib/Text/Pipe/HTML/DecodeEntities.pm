...
Text::Pipe::HTML::DecodeEntities - Text pipe that can decode HTML entitites
...
Text::Pipe::HTML::DecodeEntities inherits from L<Text::Pipe::Base>.
...
Takes a single string, decodes it with HTML entities, and returns it.
